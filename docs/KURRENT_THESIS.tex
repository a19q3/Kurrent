...
\[
  ...
  \mathsf{state\_root}_n \;=\; H_{\mathrm{KurrentState/v1}}\bigl(&
   \mathsf{settlement\_mask}_n \,\|\, \mathsf{0x00} \,\|\, \mathrm{commitSPK}(\mathrm{spk}_A)
    \,\|\, \mathrm{le64}(v_A) \\
...
\begin{center}
\small
\texttt{mask || 0x00 || commitSPK(spk\_A) || le64(v\_A)}\\
